...
RRStatus CommandSpecInit(RedisModuleCtx *ctx, RedisRaftConfig *config)
{
    static CommandSpec commands[] = {
            ...
            { "sinter",                 CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            { "sunion",                 CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            { "sdiff",                  CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            { "smembers",               CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            ...
            { "hkeys",                  CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            { "hvals",                  CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            { "hgetall",                CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
            { "hexists",                CMD_SPEC_READONLY },
            { "hscan",                  CMD_SPEC_READONLY | CMD_SPEC_RANDOM },
            { "randomkey",              CMD_SPEC_READONLY | CMD_SPEC_RANDOM },
            { "keys",                   CMD_SPEC_READONLY | CMD_SPEC_SORTABLE },
