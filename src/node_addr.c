...
/* Add a NodeAddrListElement to a chain of elements.  If an existing element
 * with the same address already exists, nothing is done. The addr pointer
 * provided is copied into newly  allocated memory, caller should free addr
 * if necessary.
 */
